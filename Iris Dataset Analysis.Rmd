...
```
The scatterplot matrix shows that the Sepal Length and Petal Length are highly correlated. In other words, if the Sepal Length of the flower is long, we can expect the petal length to be long as well, and vice versa. 

However, at times reading a scatterplot matrix can be difficult, as it is used to determine *rough* linear correlations. 
...
![Setosa](/Users/cmlach/Documents/Beginner_Repo/Beginner_Repo/Iris-Dataset-Analysis_files/figure-gfm/Flowers.png)
References:
